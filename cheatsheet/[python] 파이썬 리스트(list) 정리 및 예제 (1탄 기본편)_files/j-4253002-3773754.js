//Generated:2023-02-15 20:31:14// 6-273
(function() {
  var o = {
    $: function(el) {
      var x = el || o.divID,
  ...
  var data = {
    params: window.ftParams_4253002 || '',
    guid: window.ftGUID_4253002 || '',
    confID: window.ftConfID_4253002 || '0',
    ftReturn: window.ftReturn_4253002 || '',
    keyword: window.ftKeyword_4253002 || '',
    ftId: window.ftId_4253002 || '',
    ftImpId: window.ftImp4253002 && window.ftImp4253002.impID || '',
    gdpr: window.ftImp4253002 && window.ftImp4253002.gdpr || '',
    gdpr_consent: window.ftImp4253002 && window.ftImp4253002.gdpr_consent || '',
    gdpr_pd: window.ftImp4253002 && window.ftImp4253002.gdpr_pd || '',
    us_privacy: window.ftImp4253002 && window.ftImp4253002.us_privacy || '',
    campaignID: '115740',
    cID: '155251',
    pID: '4253002',
    creativeID: '3773754',
    ...
    extscript: [
      "https://cdn.doubleverify.com/dvtp_src.js?ctx=1828362&cmp=115740&sid=18330&plc=4253002&num=&adid=&advid=&adsrv=29&btreg=4253002&btadsrv=flashtalking&crt=3773754&crtname=&chnl=&unit=&pid=&uid=&dvtagver=6.1.src&dvp_ftimpid=[FT_IMPRESSIONID]&auevent=[ftqs:[ft_dv]]"
    ],
    clickTags: ["https://servedby.flashtalking.com/click/8/115740;4253002;3773754;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=600&url=https://www.adobe.com/kr/creativecloud/plans.html?plan=edu&sdid=TKZTLFVF&mv=display"], 
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?218815686-4253002;3773754;',
    centreAd: false,
    width: 300,
    height: 600,
    adType: 'custom_rule'.toLowerCase(),
    altimg: 'http://cdn.flashtalking.com/xre/425/4253002/3773754/image/3773754.gif',
    viewableImpressionURL: 'https://servedby.flashtalking.com/imp/8/115740;4253002;202;pixel;DV360;DV360FY20EDULALEDUOPMKRDSKBAN300x600/?',
    stump: 'https://servedby.flashtalking.com',
    altimghref: "https://servedby.flashtalking.com/click/8/115740;4253002;3773754;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=600&url=https://www.adobe.com/kr/creativecloud/plans.html?plan=edu&sdid=TKZTLFVF&mv=display",
    divID: 'ftdiv4253002',
    altimgID: 'ftalt4253002',
    alttext: 'Click here',
    w: window,
    adDisplayed: false,
    customPos: false,
    ...
    append: !!(window.ftImp4253002 && parseInt(window.ftImp4253002.jsAppend, 10) === 1),
    ...
    secure: !!(location.protocol === 'https:' || /^https:/.test((document.getElementById('ftscript_m4253002') || {}).src) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc', ''))),
    scriptLocation: document.getElementById('ftscript_m4253002'),
    pageVisible: 'maybe',
...
(function(o) {
	if (o.width === 1 && o.height === 2){
		o.addEventListener("obaEnd", function(){
		    try {
		        document.getElementById("ftAdChoices_4253002").style.display = "none";

		    } catch(e){
		        window.parent.document.getElementById("ftAdChoices_4253002").style.display = "none";
		    }
		});
	}
}(ft4253002));
...
(function(o){
    ...
    var scriptToFire = "https://js.ad-score.com/score.min.js?pid=1000557&tt=g#tid=13539&l1=115740&l2=DV360&l3=4253002&l4=3773754&l5=&l6=&utid=[%FT_IMPRESSIONID%]&cb=[%random%]";
    var pixelToFire = "https://img-1000557.ad-score.com/img?pid=1000557&tid=13539&tt=g&l1=115740&l2=DV360&l3=4253002&l4=3773754&utid=[%FT_IMPRESSIONID%]&creative_type=display&cb=[%random%]";
...
(function(o) {
  ...
  // var windowDvVariable = window.ftClick_4253002;
  var windowDvVariable = "",
      // windowFtParams = window.ftParams_6001356;
      windowFtParams = window.ftParams_4253002;
